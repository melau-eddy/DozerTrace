...
#define _EMAIL "georgesmars8@gmail.com"
...
// ntp
#define NTP_TIMESERVER "0.ke.pool.ntp.org"	// Country and region specific
#define NTP_TIMEZONES	3					// How far is our Timezone from UTC (excl daylight saving/summer time) +3 hours
#define SECS_PER_HOUR	3600
#define NTP_INTR 0							// Do NTP processing with interrupts or in loop();

#if GATEWAYNODE==1
#define _DEVADDR { 0x27, 0xFC, 0x7C, 0xC9 }
#define _APPSKEY { 0xDC, 0x3C, 0x23, 0xDF, 0x10, 0x37, 0x69, 0x45, 0x0D, 0x9A, 0x40, 0xB3, 0xBB, 0x7B, 0x32, 0xF8 }
#define _NWKSKEY { 0x94, 0x7F, 0x9E, 0xF0, 0xD2, 0x3E, 0xB4, 0x45, 0xD0, 0x10, 0x85, 0xD6, 0xAB, 0x4E, 0x59, 0x4C }
