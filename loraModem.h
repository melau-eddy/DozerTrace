...
// For ComResult gateway PCB use the following settings
struct pins {
  uint8_t dio0=14;   // GPIO5 / D1. Dio0 used for one frequency and one SF
  ...
  uint8_t ss=25;    // GPIO15 / D8. Select pin connected to GPIO15
  uint8_t rst=26;    // GPIO0 / D3. Reset pin not used 
// Pin definetion of WIFI LoRa 32
// HelTec AutoMation 2017 support@heltec.cn 
#define SCK     22    // GPIO5  -- SX127x's SCK
#define MISO    19   // GPIO19 -- SX127x's MISO
#define MOSI    23   // GPIO27 -- SX127x's MOSI
#define SS      25   // GPIO18 -- SX127x's CS
#define RST     26   // GPIO14 -- SX127x's RESET
#define DI00    14   // GPIO26 -- SX127x's IRQ(Interrupt Request)  
} pins;
#else
